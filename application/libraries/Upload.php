...
class MY_Upload
{
    ...
    protected function _file_mime_type($file)
    {
         ...
         */
        if (DIRECTORY_SEPARATOR !== '\\' and function_exists('escapeshellarg')) {
